local file_path = "__advanced-fluid-handling-space-age__/graphics/entity/circuit-connector/"
...
-- local circuit_connector_def= table.deepcopy()

circuit_connector_definitions["underground-mini-pump"] = circuit_connector_definitions["programmable-speaker"]
-- (
--   underground_pump_connector_template,
--   {
