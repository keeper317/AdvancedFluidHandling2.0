    ...
    {
        {
            ...
            icon_size = 128,
            icon = '__advanced-fluid-handling-space-age__/graphics/technology/advanced-underground-piping-t1.png',
        ...
        },
        {
            ...
            icon_size = 128,
            icon = '__advanced-fluid-handling-space-age__/graphics/technology/advanced-underground-piping-t2.png',
        ...
        },
        {
            ...
            icon_size = 128,
            icon = '__advanced-fluid-handling-space-age__/graphics/technology/advanced-underground-piping-t3.png',
